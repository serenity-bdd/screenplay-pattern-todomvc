...
public class TodoList {
    ...
    public static Target TOGGLE_ALL_LABEL = Target.the("Toggle all items").locatedBy("[for='toggle-all']");
    public static Target TOGGLE_ALL_BUTTON = Target.the("Toggle all items link").locatedBy("#toggle-all");
    public static Target CLEAR_COMPLETED = Target.the("Clear completed link").locatedBy(".clear-completed");
    public static Target FILTER = Target.the("filter by {0}").locatedBy("//a[.='{0}']");
